...
!(function (jQuery, undefined) {
	...
	jQuery.extend(!0, _R, {
		...
		compare_version: function (e) {
			...
			return (
				(i = i === undefined ? new Object() : i).Core === undefined &&
					((i.Core = new Object()), (i.Core.alias = "Slider Revolution Core"), (i.Core.name = "jquery.themepunch.revolution.min.js"), (i.Core.ver = _R.getversion().core)),
				"stop" != e.check &&
		...
		setSize: function (e) {
			...
			if (
				((e.paddings = e.paddings === undefined ? {top: parseInt(e.c.parent().css("paddingTop"), 0) || 0, bottom: parseInt(e.c.parent().css("paddingBottom"), 0) || 0} : e.paddings),
	...
	var _ISM = _R.is_mobile(),
		...
		runSlider = function (t, x) {
			...
			if (
					...
					t.find(".tp-caption, .rs-background-video-layer").each(function (e) {
						...
						(i.startclasses = n.attr("class")),
							...
							n.hasClass("tp-static-layer") &&
								...
								x.scrolleffect.on &&
									(("on" === x.scrolleffect.on_parallax_static_layers && i.isparallaxlayer) || ("on" === x.scrolleffect.on_static_layers && !i.isparallaxlayer)) &&
									(l = !0),
								(s = !1));
				...
				t.append(
					'<div class="tp-loader ' + x.spinner + '"><div class="dot1"></div><div class="dot2"></div><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>'
				),
				...
				(x.inviewport = !1),
					g != undefined &&
						g.enable &&
						(jQuery.isNumeric(g.visible_area) || (-1 !== g.visible_area.indexOf("%") && (g.visible_area = parseInt(g.visible_area) / 100)), _R.scrollTicker && _R.scrollTicker(x, t)),
					"carousel" === x.sliderType &&
						_R.prepareCarousel &&
						(punchgs.TweenLite.set(x.ul, {opacity: 0}), _R.prepareCarousel(x, new punchgs.TimelineLite(), undefined, 0), (x.onlyPreparedSlide = !0)),
					setTimeout(function () {
								...
								i.data("closestli") === undefined && (i.data("closestli", t), i.data("staticli", a)),
									((0 < t.length && t.hasClass("active-revslide")) || t.hasClass("processing-revslide") || 0 < a.length) &&
										...
										_R.playAnimationFrame &&
											_R.playAnimationFrame({caption: i, opt: n, frame: "frame_0", triggerdirection: "in", triggerframein: "frame_0", triggerframeout: "frame_999"}),
						...
						n.layersonhover &&
							jQuery.each(n.layersonhover, function (e, i) {
								i.data("animdirection", "out"),
									...
									_R.playAnimationFrame &&
										_R.playAnimationFrame({caption: i, opt: n, frame: "frame_999", triggerdirection: "out", triggerframein: "frame_0", triggerframeout: "frame_999"});
							});
					}),
